  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '校准溶液-定位值Ⅰ', prop: 'zd6', value: '', type: 'input', isRqd: true},
        {label: '校准溶液-定位值Ⅱ', prop: 'zd7', value: '', type: 'input', isRqd: true},
        {label: '校准溶液-定位值Ⅲ', prop: 'zd8', value: '', type: 'input', isRqd: true},
