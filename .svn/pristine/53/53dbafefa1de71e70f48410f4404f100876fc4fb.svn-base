<template>
  <div class="" style="margin-top: 15px;position: relative;">
    <div style="width: 100%;text-align: center;position: absolute;top: 5px;font-size: 15px;color: #0195DB;">质控样品测定</div>
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      this.tableData.push(
        {id: null, zd1: '质控样()', zd2: '有证标准样品', edit: true}
      )
    },
    handleEdit(params) {
      let ids = {...params}
