...
export default {
  ...
  data () {
    return {
      ...
      pointValue: '', // 选中的点位
      fromItemList: [
        {label: '采样点名称及编号', prop: 'zd1', value: '', type: 'input', isRqd: true},
        {label: '仪器名称及型号', prop: 'zd2', value: '', type: 'input', isRqd: true, click: 'handleMachine'},
        ...
        {label: '状态体积名称(副表)', prop: 'zd10', value: '', type: 'input', isRqd: true},
        {label: '污染物含量单位(副表)', prop: 'zd11', value: '', type: 'input', isRqd: true},
        {label: '污染物浓度单位(副表)', prop: 'zd12', value: '', type: 'input', isRqd: true},
  ...
  watch: {
    ...
    'fromValiData.zd10': {
      handler (newName, oldName) {
        ...
        let obj = this.tableHeader.find(xdd => xdd.prop === 'zd12')
        obj.label = '(' + newName + ')' + '状态体积(L)'
      },
      immediate: true,
      deep: true
    },
    ...
    'fromValiData.zd11': {
      handler (newName, oldName) {
        ...
        let obj = this.tableHeader.find(xdd => xdd.prop === 'zd13')
        obj.label = '污染物含量' + '(' + newName + ')'
      },
      immediate: true,
      deep: true
    },
    ...
    'fromValiData.zd12': {
      handler (newName, oldName) {
        ...
        let obj = this.tableHeader.find(xdd => xdd.prop === 'zd14')
        obj.label = '污染物浓度' + '(' + newName + ')'
      },
      immediate: true,
      deep: true
    }
