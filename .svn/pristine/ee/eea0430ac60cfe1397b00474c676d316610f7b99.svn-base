...
<template>
  <div class="pc-container contractTask">
    ...
    <tableItem :obj="this" :tableData="tableData" :tableHeader="tableHeader"  :dataSum='fromValiData.dataSum' :loading="loading" :isSelection="false" @handleSizeChange="handleSizeChange">
...
<script>
import pointList from '../../contract/task/point_list'
import cycleEdit from '../../contract/task/cycle_edit.vue'
import majorList from '../../contract/task/major_list.vue'
import start from '../../contract/task/start.vue'
import planList from '../../contract/task/plan_list.vue'
import cycle from '../../contract/task/cycle.vue'
...
export default {
  ...
  data() {
    return {
      ...
      fromValiData: {
        ...
        busiType: '1,3', // 业务类别:1纯检测，2纯咨询，3检测和咨询
        status: '05,06,07'
      },
      fromData: [
  ...
  methods: {
    ...
    doReset(formName) {
      this.fromValiData.pageNow = 1
      this.fromValiData.status = '02,06,07'
      this.statusValue = ''
