...
<template>
  <homeRecord
    ...
    <F148Son :params="fromValiData"></F148Son>
  </homeRecord>
</template>
...
import F148Son from '../F_148_son.vue'
  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '分析依据', prop: 'zd47', value: '', type: 'input', isRqd: true},
        ...
        {label: '干扰实验CO允许最大值', prop: 'zd7', value: '', type: 'input', isRqd: true, append: 'mg/m³'},
        ...
        {label: '样品编号', prop: 'zd10', value: '', type: 'input', isRqd: true},
  ...
  methods: {
    ...
    handleAdd() {
      ...
      if (this.pointValue === '') {
        ...
        this.tableData.push(
          {id: null, zd1: this.pointValue, zd2: ':', edit: true},
          {id: null, zd1: this.pointValue, zd2: ':', edit: true},
          {id: null, zd1: this.pointValue, zd2: ':', edit: true},
          {id: null, zd1: this.pointValue, zd2: ':', edit: true},
          {id: null, zd1: this.pointValue, zd2: ':', edit: true},
          {id: null, zd1: this.pointValue, zd2: '平均值', edit: true}
        )
      }
    },
    handleSave() {
