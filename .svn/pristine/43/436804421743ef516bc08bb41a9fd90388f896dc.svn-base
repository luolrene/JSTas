  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '采样地点', prop: 'zd2', value: '', type: 'input', isRqd: true},
        {label: '样品名称', prop: 'zd3', value: '', type: 'input', isRqd: true},
        {label: '接待人', prop: 'zd4', value: '', type: 'input', isRqd: true},
        {label: '监测目的', prop: 'zd5', value: '', type: 'input', isRqd: true},
        {label: '采样方法', prop: 'zd6', value: '', type: 'input', isRqd: true},
        {label: '监测依据', prop: 'zd7', value: '', type: 'input', isRqd: true},
        {label: '电话', prop: 'zd8', value: '', type: 'input', isRqd: true},
        {label: '废物产生源', prop: 'zd9', value: '', type: 'input', isRqd: true},
        {label: '废物堆放面积（m²）', prop: 'zd10', value: '', type: 'input', isRqd: true},
        {label: '废物堆存量（吨）', prop: 'zd11', value: '', type: 'input', isRqd: true},
        {label: '天气', prop: 'zd12', value: '', type: 'input', isRqd: true},
        {label: '废物形态', prop: 'zd13', value: '', type: 'input', isRqd: true},
        {label: '监测项目', prop: 'zd14', value: '', type: 'input', isRqd: true},
        ...
        {label: '采样布点图', prop: 'zd16', value: '', type: 'draw', isRqd: true},
        {label: '废物性状及外观描述', prop: 'zd17', value: '', type: 'textarea', isRqd: true},
        {label: '采样现场环境概况描述', prop: 'zd18', value: '', type: 'textarea', isRqd: true},
        {label: '样品混合与缩分方法', prop: 'zd19', value: '', type: 'textarea', isRqd: true},
        {label: '备注', prop: 'zd20', value: '', type: 'textarea', isRqd: true}
      ],
  ...
  methods: {
    ...
    commonContent() {
      if (this.fromValiData.id === null) {
        ...
        this.fromValiData.zd4 = this.fromValiData.contacts
        this.fromValiData.zd8 = this.fromValiData.contactsMobile
        this.fromValiData.zd2 = this.fromValiData.address
      }
