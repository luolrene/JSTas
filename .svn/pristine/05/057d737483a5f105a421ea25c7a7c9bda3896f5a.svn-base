  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '校准溶液-氧化还原电位值E(mV)', prop: 'zd6', value: '', type: 'input', isRqd: true},
        {label: '校准溶液-温度(℃)', prop: 'zd7', value: '', type: 'input', isRqd: true},
        {label: '采样人', prop: 'zd50', value: '', type: 'select', isRqd: true, data: [], multiple: true, isNoClear: true, filterable: true},
        {label: '采样日期', prop: 'zd8', value: '', type: 'date', isRqd: true},
