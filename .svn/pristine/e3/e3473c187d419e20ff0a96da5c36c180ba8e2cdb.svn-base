  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '测点距离1', prop: 'zd17', value: '', type: 'input', isRqd: true},
        {label: '测点距离2', prop: 'zd18', value: '', type: 'input', isRqd: true},
        {label: '测点距离3', prop: 'zd19', value: '', type: 'input', isRqd: true},
        {label: '测点距离4', prop: 'zd20', value: '', type: 'input', isRqd: true},
        {label: '测点距离5', prop: 'zd21', value: '', type: 'input', isRqd: true},
        {label: '测点距离6', prop: 'zd22', value: '', type: 'input', isRqd: true},
        {label: '测点距离7', prop: 'zd23', value: '', type: 'input', isRqd: true},
      ...
      if (this.pointValue === '') {
        ...
        getSamplingTaskQuerySampNoPage(ids).then(res => {
          res.result.pageList.forEach((xdd, index) => {
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '尘重g' + (index + 1) + '=', zd11: 'g', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '烟气流速VS' + (index + 1) + '=', zd11: 'm/s', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '烟气流量QSNd' + (index + 1) + '=', zd11: 'm³/h', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '烟尘浓度C' + (index + 1) + '=', zd11: 'mg/m³', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '烟尘排放浓度CN' + (index + 1) + '=', zd11: 'mg/m³', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '烟尘排放速率G' + (index + 1) + '=', zd11: 'kg/h', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '单位产品排放量Upe=', zd11: 'kg/t', edit: false})
          })
        })
      }
    },
