...
export default {
  ...
  data() {
    return {
      ...
      fromItemList: [
        ...
        {label: '振源名称及型号', prop: 'zd6', value: '', type: 'input', isRqd: true, click: 'handleMachine'},
        {label: '振动类别',
          prop: 'zd7',
          value: '',
          type: 'select',
          isRqd: true,
          data: [{ id: '稳态', name: '稳态' }, { id: '冲击', name: '冲击' }]},
        {label: '检测人员', prop: 'zd50', value: '', type: 'select', isRqd: true, data: [], multiple: true, isNoClear: true, filterable: true},
        {label: '检测日期', prop: 'zd8', value: '', type: 'date', isRqd: true},
        ...
        {label: '备注2', prop: 'zd12', value: '', type: 'textarea', isRqd: true}
      ],
      ...
      tableHeader: [
        ...
        { prop: 'zd1', label: '点位编号', type: 'input', width: 180 },
        ...
        { prop: 'zd11', label: '平均值', type: 'input', width: 80 }
      ],
      button: {
        width: 170,
        buttonList: [
  ...
  methods: {
    ...
    getMachineData(data) {
      ...
      } else if (this.presentMachine === 'zd6') {
        let zd6 = ''
        data.forEach(xdd => {
          // 振源名称及型号
          zd6 += xdd.name + xdd.machineXh + ';'
        })
