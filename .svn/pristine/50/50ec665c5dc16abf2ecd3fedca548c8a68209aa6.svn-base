...
import { getCustGetDataOne } from '@/api/client/info.js'
...
export default {
  ...
  mounted() {
    getCustGetDataOne({
      ...
      if (this.details.importantCustomers === '1') {
        this.details.importantCustomers = '普通客户'
      } else if (this.details.importantCustomers === '2') {
        this.details.importantCustomers = '重点客户'
      } else if (this.details.importantCustomers === '3') {
        this.details.importantCustomers = 'VIP客户'
      }
      if (this.details.customerType === '1') {
        this.details.customerType = '已有订单'
      } else if (this.details.customerType === '2') {
        this.details.customerType = '从无订单'
      } else if (this.details.customerType === '3') {
