...
import { getCustGetAllName } from '@/api/client/info.js'
...
export default {
  ...
  mounted() {
    getCustGetAllName({
      ...
      if (this.details.type === '5') {
        this.details.typeName = '国有企业'
      }
      if (this.details.type === '6') {
        this.details.typeName = '外资企业'
      }
      if (this.details.type === '7') {
