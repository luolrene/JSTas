<template>
  <homeRecord
    ...
    <F88Son :params="fromValiData"></F88Son>
  </homeRecord>
</template>
...
import F88Son from '../F_88_son.vue'
  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '检测日期', prop: 'zd2', value: '', type: 'input', isRqd: true},
        {label: '分析日期', prop: 'zd3', value: '', type: 'input', isRqd: true},
