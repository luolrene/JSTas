  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '排污口名称及编号', prop: 'zd2', value: '', type: 'input', isRqd: true},
        ...
        {label: '报告日期', prop: 'zd6', value: '', type: 'date', isRqd: true},
        {label: '排放规律(以流速变化判断)',
          prop: 'zd9',
          value: '',
          type: 'select',
        ...
        {label: '测试断面示意图（标明尺寸）', prop: 'zd7', value: '', type: 'draw', isRqd: true},
