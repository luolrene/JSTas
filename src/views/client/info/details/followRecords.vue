...
<template>
  <div class="pc-container">
    <fromSearch ref="fromSearch" :obj="this" :fromValiData="fromValiData" :fromData="fromData">
      ...
      <!-- <el-button type="primary" :size="$layer_Size.buttonSize" class="default-btn" icon="el-icon-plus" @click="handleAdd()" v-if="this.$store.getters.userInfo.userId === trackPersonnel">添加</el-button> -->
...
<script>
import followRecordsEdit from './followRecords_edit.vue'
