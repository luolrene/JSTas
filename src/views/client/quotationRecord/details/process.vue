<template>
  ...
  <div class="operate-container" style="position:relative">
    ...
    <el-steps direction="vertical" :space="100" :active="active+1" style="padding: 0 20px;">
...
<script>
// import {
//   getCrmBiddingGetNode
// } from '../../../../api/bid/bid.js'
import { getCrmOfferGetNode } from '@/api/client/quotationRecord.js'
...
export default {
  ...
  methods: {
    getListData(logList) {
      getPathQueryPathItems({ mainId: this.params.trigger }).then(res => {
      ...
      getCrmOfferGetNode({ id: this.params.id }).then(res => {
