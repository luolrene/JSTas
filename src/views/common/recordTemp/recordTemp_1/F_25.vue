  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '最大声级值(LAmax)', prop: 'zd24', value: '', type: 'input', isRqd: true, append: 'dB'},
        {label: '样品编号', prop: 'zd25', value: '', type: 'input', isRqd: true},

        {label: '测点示意图', prop: 'zd19', value: '', type: 'draw', isRqd: true},
        {label: '测量工况', prop: 'zd20', value: '', type: 'textarea', isRqd: true},
        {label: '备注', prop: 'zd21', value: '', type: 'textarea', isRqd: true},
        {label: '备注2', prop: 'zd22', value: '', type: 'textarea', isRqd: true, row: 2}
      ],
  ...
  methods: {
    ...
    commonContent() {
      if (this.fromValiData.id === null) {
        ...
        this.$set(this.fromValiData, 'zd22', `噪声测量值依据《环境噪声检测技术规范 噪声测量值修正（HJ 706-2014）》进行修正。`)
      }
