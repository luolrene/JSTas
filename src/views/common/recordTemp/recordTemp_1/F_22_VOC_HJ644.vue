...
import FTarget from '../F_target.vue'
import {temp22VOCHJ644, header22} from '@/utils/recordTarget.js'
...
export default {
  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '状态体积名称(副表)', prop: 'zd6', value: '', type: 'input', isRqd: true},
        {label: '污染物浓度单位(副表)', prop: 'zd7', value: '', type: 'input', isRqd: true},
  ...
  methods: {
    ...
    handleTarget(params) {
      ...
      this.$layer.iframe({
        content: {
          content: FTarget, // 传递的组件对象
          parent: this, // 当前的vue对象
          data: {
            params: ids,
            targetData: temp22VOCHJ644,
            tableHeader: header22,
            dw: this.fromValiData.zd7
          }// props
        },
        area: this.$layer_Size.Max,
        title: '指标选择',
