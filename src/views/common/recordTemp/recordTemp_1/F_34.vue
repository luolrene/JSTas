  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '测试时加风罩', prop: 'zd2', value: '', type: 'input', isRqd: true},
        ...
        {label: '检测日期', prop: 'zd3', value: '', type: 'date', isRqd: true},
        ...
        {label: '备注', prop: 'zd22', value: '', type: 'textarea', isRqd: true, row: 2}
      ],
  ...
  methods: {
    ...
    commonContent() {
      if (this.fromValiData.id === null) {
        ...
        this.$set(this.fromValiData, 'zd22', '道路等级：1、城市快速路；2、城市主干道；3、城市次干道；4、城市含路面轨道交通的道路；5、穿过城市的高速公路；6、其他道路。')
      }
