  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '适用标准类别', prop: 'zd4', value: '', type: 'input', isRqd: true},
        {label: '测试时加风罩', prop: 'zd25', value: '', type: 'input', isRqd: true},
        ...
        {label: '报告日期', prop: 'zd18', value: '', type: 'date', isRqd: true},
        {label: '测点示意图', prop: 'zd19', value: '', type: 'draw', isRqd: true},
        {label: '测量打印原始记录及测量结果-昼间', prop: 'zd20', value: '', type: 'textarea', isRqd: true, row: 2},
        {label: '测量打印原始记录及测量结果-夜间', prop: 'zd21', value: '', type: 'textarea', isRqd: true, row: 2},
        {label: '备注', prop: 'zd22', value: '', type: 'textarea', isRqd: true},
        {label: '备注2', prop: 'zd23', value: '', type: 'textarea', isRqd: true, row: 2}
      ],
      ...
      if (this.pointValue === '') {
        ...
        getSamplingTaskQuerySampNoPage(ids).then(res => {
          res.result.pageList.forEach(xdd => {
            this.tableData.push({id: null, zd1: xdd.pointNo, zd50: xdd.sampNo, edit: false})
          })
        })
      }
    },
