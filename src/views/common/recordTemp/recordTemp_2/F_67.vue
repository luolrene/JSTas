  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '电话', prop: 'zd3', value: '', type: 'input', isRqd: true},
        {label: '地址', prop: 'zd4', value: '', type: 'input', isRqd: true},
        {label: '排放类别', prop: 'zd5', value: '', type: 'input', isRqd: true},
        {label: '检测方法', prop: 'zd48', value: '', type: 'input', isRqd: true, click: 'handleProject'},
        {label: '检测依据', prop: 'zd47', value: '', type: 'input', isRqd: true},
        {label: '检测工况', prop: 'zd7', value: '', type: 'input', isRqd: true},
        {label: '排气筒高度（m）', prop: 'zd8', value: '', type: 'input', isRqd: true},
        {label: '检测人员', prop: 'zd50', value: '', type: 'select', isRqd: true, data: [], multiple: true, isNoClear: true, filterable: true},
        {label: '检测日期', prop: 'zd9', value: '', type: 'date', isRqd: true},
        {label: '测试断面示意图（标明尺寸）', prop: 'zd10', value: '', type: 'draw', isRqd: true},
