  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '地面状况', prop: 'zd7', value: '', type: 'input', isRqd: true},
        ...
        {label: 'VLZ', prop: 'zd12', value: '', type: 'input', isRqd: true},
        {label: '测点示意图', prop: 'zd9', value: '', type: 'draw', isRqd: true},
        {label: '备注', prop: 'zd10', value: '', type: 'textarea', isRqd: true},
        {label: '处理结果', prop: 'zd11', value: '', type: 'textarea', isRqd: true}
      ],
