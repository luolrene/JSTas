  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '测试时加风罩', prop: 'zd5', value: '', type: 'input', isRqd: true},
        ...
        {label: '测量打印原始记录及测量结果', prop: 'zd22', value: '', type: 'textarea', isRqd: true},
        {label: '备注', prop: 'zd23', value: '', type: 'textarea', isRqd: true, row: 2}
      ],
  ...
  methods: {
    ...
    commonContent() {
      if (this.fromValiData.id === null) {
        ...
        this.$set(this.fromValiData, 'zd23', 'Ld=        dB(A)；Ln=         dB(A)')
      }
