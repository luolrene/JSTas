...
import {temp49VOCHJ734, header49} from '@/utils/recordTarget.js'
  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '检测日期', prop: 'zd5', value: '', type: 'date', isRqd: true},
        {label: '备注', prop: 'zd6', value: '', type: 'textarea', isRqd: true}
      ],
  ...
  methods: {
    ...
    handleTarget(params) {
      ...
      this.$layer.iframe({
        content: {
          ...
          data: {
            params: ids,
            targetData: temp49VOCHJ734,
            tableHeader: header49
          }// props
        },
        area: this.$layer_Size.Max,
        title: '指标选择',
    ...
    commonContent() {
      if (this.fromValiData.id === null) {
        ...
        this.$set(this.fromValiData, 'zd6', '该表适用于有组织排放废气使用吸收液、吸附柱等采样。')
      }
