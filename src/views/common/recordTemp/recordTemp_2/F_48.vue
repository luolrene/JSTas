  ...
  methods: {
      ...
      if (this.pointValue === '') {
        ...
        getSamplingTaskQuerySampNoPage(ids).then(res => {
          res.result.pageList.forEach(xdd => {
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '烟气流速VS1 =', zd11: 'm/s', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '烟气流量QSNd1 =', zd11: 'm³/h', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '含量g1 =', zd11: 'μg', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '标况采样体积Vnd =', zd11: 'L', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '实测浓度C1 =', zd11: 'mg/m³', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '排放浓度CN1 =', zd11: 'mg/m³', edit: false})
            this.tableData.push({id: null, zd50: xdd.sampNo, zd9: '排放速率G1 =', zd11: 'kg/h', edit: false})
          })
        })
      }
    },
    ...
    commonContent() {
      if (this.fromValiData.id === null) {
        ...
        this.$set(this.fromValiData, 'zd16', `该表适用于废气有组织排放使用滤筒、气袋等方法采样`)
      }
