...
export default {
  ...
  data () {
    return {
      ...
      pointValue: '', // 选中的点位
      fromItemList: [
        {label: '仪器名称', prop: 'zd1', value: '', type: 'input', isRqd: true, click: 'handleMachine'},
        {label: '仪器型号', prop: 'zd2', value: '', type: 'input', isRqd: true},
        {label: '仪器编号', prop: 'zd3', value: '', type: 'input', isRqd: true},
        {label: '有效期至', prop: 'zd4', value: '', type: 'input', isRqd: true},
        {label: '天平室温度', prop: 'zd5', value: '', type: 'input', isRqd: true, append: '℃'},
        {label: '天平室湿度', prop: 'zd6', value: '', type: 'input', isRqd: true, append: '%RH'},
        {label: '滤膜平衡温度', prop: 'zd7', value: '', type: 'input', isRqd: true, append: '℃'},
        {label: '滤膜平衡湿度', prop: 'zd8', value: '', type: 'input', isRqd: true, append: '%RH'},
        {label: '滤膜平衡开始日期时间', prop: 'zd9', value: '', type: 'input', isRqd: true},
        {label: '滤膜平衡结束日期时间', prop: 'zd10', value: '', type: 'input', isRqd: true},
        {label: '称量日期', prop: 'zd11', value: '', type: 'input', isRqd: true},
        {label: '检测人员', prop: 'zd50', value: '', type: 'select', isRqd: true, data: [], multiple: true, isNoClear: true, filterable: true},
        {label: '报告日期', prop: 'zd12', value: '', type: 'date', isRqd: true},
        {label: '备注', prop: 'zd13', value: '', type: 'textarea', isRqd: true}
      ],
