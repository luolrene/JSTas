  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '检测仪器-有效期', prop: 'zd10', value: '', type: 'input', isRqd: true},
        ...
        {label: '校准仪器-有效期', prop: 'zd14', value: '', type: 'input', isRqd: true},
        {label: '测量前后校准情况-测量前（dB）', prop: 'zd15', value: '', type: 'input', isRqd: true},
        {label: '测量前后校准情况-测量后（dB）', prop: 'zd16', value: '', type: 'input', isRqd: true},
        {label: '测量结果有效性判定',
          prop: 'zd17',
          value: '',
          type: 'select',
        ...
        {label: '检测日期', prop: 'zd20', value: '', type: 'date', isRqd: true},
        {label: 'LAeq，T均值(副表)', prop: 'zd22', value: '', type: 'input', isRqd: true},
        {label: '本底值(副表)', prop: 'zd23', value: '', type: 'input', isRqd: true},
        {label: '修正值(副表)', prop: 'zd24', value: '', type: 'input', isRqd: true},
        {label: '结果(副表)', prop: 'zd25', value: '', type: 'input', isRqd: true},
        {label: '测点示意图', prop: 'zd21', value: '', type: 'draw', isRqd: true}
      ],
