  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '检测仪器-名称及型号', prop: 'zd4', value: '', type: 'input', isRqd: true, click: 'handleMachine'},
        {label: '检测仪器-编号', prop: 'zd5', value: '', type: 'input', isRqd: true},
        {label: '检测仪器-有效期至', prop: 'zd6', value: '', type: 'input', isRqd: true},
        ...
        {label: '报告日期', prop: 'zd7', value: '', type: 'date', isRqd: true},
        {label: '测点示意图', prop: 'zd8', value: '', type: 'draw', isRqd: true},
        {label: '备注', prop: 'zd9', value: '', type: 'textarea', isRqd: true},
        {label: '备注2', prop: 'zd10', value: '', type: 'textarea', isRqd: true}
      ],

      tableData: [],

      tableHeader: [
        {prop: 'zd21', label: '样品编号', fixed: 'left', type: 'input', width: 200},
        {prop: 'zd1', label: '编号', fixed: 'left', type: 'input', width: 180},
        {prop: 'zd21', label: '1', type: 'input', width: 80},
        {prop: 'zd2', label: '2', type: 'input', width: 80},
        {prop: 'zd3', label: '3', type: 'input', width: 80},
        {prop: 'zd4', label: '4', type: 'input', width: 80},
        {prop: 'zd5', label: '5', type: 'input', width: 80},
        {prop: 'zd6', label: '6', type: 'input', width: 80},
        {prop: 'zd7', label: '7', type: 'input', width: 80},
        {prop: 'zd8', label: '8', type: 'input', width: 80},
        {prop: 'zd9', label: '9', type: 'input', width: 80},
        {prop: 'zd10', label: '10', type: 'input', width: 80},
        {prop: 'zd11', label: '11', type: 'input', width: 80},
        {prop: 'zd12', label: '12', type: 'input', width: 80},
        {prop: 'zd13', label: '13', type: 'input', width: 80},
        {prop: 'zd14', label: '14', type: 'input', width: 80},
        {prop: 'zd15', label: '15', type: 'input', width: 80},
        {prop: 'zd16', label: '16', type: 'input', width: 80},
        {prop: 'zd17', label: '17', type: 'input', width: 80},
        {prop: 'zd18', label: '18', type: 'input', width: 80},
        {prop: 'zd19', label: '19', type: 'input', width: 80},
        {prop: 'zd20', label: '20', type: 'input', width: 80}
      ],
      button: {
        width: 170,
        buttonList: [
      ...
      if (this.pointValue === '') {
        ...
        getSamplingTaskQuerySampNoPage(ids).then(res => {
          res.result.pageList.forEach(xdd => {
            this.tableData.push({id: null, zd1: xdd.pointNo, zd21: xdd.sampNo, edit: false})
          })
        })
      }
    },
