  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '校准液Ⅰ浓度', prop: 'zd8', value: '', type: 'input', isRqd: true, append: 'mg/L'},
        {label: '校准液Ⅱ浓度', prop: 'zd9', value: '', type: 'input', isRqd: true, append: 'mg/L'},
        {label: '分析人员', prop: 'zd50', value: '', type: 'select', isRqd: true, data: [], multiple: true, isNoClear: true, filterable: true},
        {label: '报告日期', prop: 'zd10', value: '', type: 'date', isRqd: true},
