  ...
  data () {
    return {
      ...
      fromItemList: [
        ...
        {label: '钢轨类型', prop: 'zd16', value: '', type: 'input', isRqd: true},
        {label: '扣件类型', prop: 'zd17', value: '', type: 'input', isRqd: true},
        {label: '轨枕类型', prop: 'zd18', value: '', type: 'input', isRqd: true},
        {label: '道枕类型', prop: 'zd19', value: '', type: 'input', isRqd: true},
        {label: '线路半径', prop: 'zd20', value: '', type: 'input', isRqd: true},
        {label: '线路轨顶埋深', prop: 'zd21', value: '', type: 'input', isRqd: true},
        {label: '距线路中心线距离', prop: 'zd22', value: '', type: 'input', isRqd: true},
        {label: '隧道结构形式', prop: 'zd23', value: '', type: 'input', isRqd: true},
        ...
        {label: '测点示意图', prop: 'zd25', value: '', type: 'draw', isRqd: true},
        {label: '建筑物类型描述', prop: 'zd26', value: '', type: 'textarea', isRqd: true},
        {label: '备注', prop: 'zd27', value: '', type: 'textarea', isRqd: true}
      ],
