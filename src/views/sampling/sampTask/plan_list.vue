<template>
  <div class="operate-container">
    <fromSearch ref="fromSearch" :obj="this" :fromValiData="fromValiData" :fromData="fromData">
      ...
      <el-button type="primary" :size="$layer_Size.buttonSize" class="default-btn" icon="" @click="doEditPlan" v-if="editPlan">指标方法修改</el-button>
      <el-button type="primary" :size="$layer_Size.buttonSize" class="default-btn" icon="" @click="doConfirmPlan" v-if="confirmPlan">方案确认</el-button>
    </fromSearch>
    <el-table
      :data="tableData"
      ...
      <el-table-column prop="targetDays" align="center" label="当前检测天数" min-width="70"></el-table-column>
      <el-table-column prop="funName" align="center" label="方法" min-width="160" show-overflow-tooltip></el-table-column>
      <el-table-column type="selection" align="center" width="90" :selectable="getSelectable" v-if="selectTableShow"></el-table-column>
    </el-table>
  </div>
</template>
  ...
  methods: {
    ...
    doConfirmPlan () {
      ...
      this.$share.confirm({
        ...
        type: 'success',
        confirm: function () {
          let ids = JSON.parse(JSON.stringify(that.params))
          ids.funIsOk = '1'
